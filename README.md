...
| | |
|---|---|
| Lógica pura | implementada, 178 tests |
| Base de datos (Room) | 15 tablas, versión 2 con su migración, DAOs y repositorios de ingredientes y recetas; 90 tests sobre una base de mentira en memoria |
| Pantallas | Menú de secciones, Ingredientes completo, Recetas con su paso de cantidades y costo en vivo; faltan precios, moldes y empleados |
