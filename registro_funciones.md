...
### revisar_simbolos, revisar_importaciones, revisar_acciones, revisar_enchufes, revisar_constantes, revisar_nombres_con_acentos, revisar_esquemas, revisar_aserciones y revisar_llamadas_con_punto ✅ IMPLEMENTADAS
- Ubicación: herramientas/revisar_kotlin.py
- Qué hacen: las nueve revisiones del código Kotlin que se pueden hacer sin compilador ni Android SDK, que es la situación de siempre acá — `:app` solo compila en el equipo de Sandy.
